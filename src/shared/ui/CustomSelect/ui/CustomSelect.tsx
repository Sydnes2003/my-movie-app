...
import {Combobox, Group, Pill, PillsInput, Input, useCombobox} from "@mantine/core";
...
const CustomSelect: FC<CustomSelectProps> = ({label= 'PLACEHOLDER', placeholder= 'PLACEHOLDER', data}) => {
